...
class FeedFoward(nn.Module):
    ...
    '''
    Holds no significance for LSTM 
    '''
    def __init__(self, n_embd):
        ...
        self.net = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(4 * n_embd, 32 * n_embd),
            nn.ReLU(),
            nn.Linear(32* n_embd, 64 * n_embd),  # Additional layer
            nn.ReLU(),
            nn.Linear(64 * n_embd, 4* n_embd),  # Additional layer
            nn.ReLU(),
